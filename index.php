			...
			<?php
				...
				foreach ($directories as $dir) {
					...
					<section class="box">
						...
						<a class="box-button" target="_blank" href="'.$repository['downloadMaster'].'"><i class="icon fa-download"></i> Download</a>
						<a class="box-button" target="_blank" href="'.$repository['github'].'"><i class="icon fa-github"></i> Github</a>
						<a class="box-button" target="_blank" href="'.$metadata['website'].'"><i class="icon fa-link"></i> Website</a>
					</section>
					</div>
					';
				}
